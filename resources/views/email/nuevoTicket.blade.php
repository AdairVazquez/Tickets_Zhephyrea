                                                        ...
                                                        <table cellpadding="0" cellspacing="0" width="100%"
                                                            ...
                                                            <tr>
                                                                <td align="center"
                                                                    ...
                                                                    <a target="_blank" href="https://zephyrea.com.mx"
                                                                        style="mso-line-height-rule:exactly;text-decoration:underline;color:#666666;font-size:14px"><img
                                                                            width="100" title="Logo"
                                                                            src="https://ezofyxy.stripocdn.email/content/guids/CABINET_9f05264130a74861efcd3514a41e9e56cb2c59f89582b9d0820215b48532ea0a/images/diseno_sin_tituloremovebgpreview_1.png"
                                                                            class=""
                                                                            style="display:block;font-size:12px;border:0;outline:none;text-decoration:none;margin:0"
                                                                            alt=""></a></td>
                                                            </tr>
                                                        </table>
                                                    </td>
                                                            ...
                                                            <tr>
                                                                <td align="center"
                                                                    ...
                                                                    <p
                                                                        ...
                                                                        Hola, hemos recibido un nuevo ticket. Por favor,
                                                                        échale un vistazo al listado y, si está dentro
                                                                        de tus posibilidades, asígnatelo para darle
                                                                        seguimiento.</p>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                            ...
                                                            <tr>
                                                                <td align="center"
                                                                    ...
                                                                    <p
                                                                        ...
                                                                        ¿Tienes algun problema para iniciar sesión?
                                                                        Ponte en contacto con alguno de los
                                                                        adminsitradores o intenta restablecer tu
                                                                        contraseña</p>
                                                                    <p
                                                                        style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px">
                                                                        <br>¡Saludos!</p>
                                                                    <p
                                                                        style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px">
                                                                        <em><u>Mensaje automatico, favor de no
                                                                                responderlo.</u></em></p>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                ...
                                                <tr>
                                                    <td align="left" style="padding:0;Margin:0;width:560px">
                                                        <table cellpadding="0" cellspacing="0" width="100%"
                                                            ...
                                                            <tr>
                                                                <td align="center"
                                                                    style="Margin:0;padding-top:15px;padding-bottom:15px;padding-right:10px;padding-left:65px;font-size:0">
                                                                    <table cellpadding="0" cellspacing="0"
                                                                        ...
                                                                        <tr>
                                                                            <td valign="top" align="center"
                                                                                style="padding:0;Margin:0;padding-right:37px">
                                                                                <a href="https://www.facebook.com/share/1CgdxKQH6j/?mibextid=wwXIfr"
                                                                                    target="_blank"
                                                                                    style="mso-line-height-rule:exactly;text-decoration:underline;color:#333333;font-size:12px"><img
                                                                                        title="Facebook"
                                                                                        src="https://ezofyxy.stripocdn.email/content/assets/img/social-icons/logo-black/facebook-logo-black.png"
                                                                                        alt="Fb" width="32"
                                                                                        style="display:block;font-size:14px;border:0;outline:none;text-decoration:none;margin:0"></a>
                                                                            </td>
                                                                            <td align="center" valign="top"
                                                                                style="padding:0;Margin:0;padding-right:40px">
                                                                                <a target="_blank"
                                                                                    href="https://www.instagram.com/zephyrea418/"
                                                                                    style="mso-line-height-rule:exactly;text-decoration:underline;color:#333333;font-size:12px"><img
                                                                                        width="32"
                                                                                        title="Instagram"
                                                                                        src="https://ezofyxy.stripocdn.email/content/assets/img/social-icons/logo-black/instagram-logo-black.png"
                                                                                        alt="Inst"
                                                                                        style="display:block;font-size:14px;border:0;outline:none;text-decoration:none;margin:0"></a>
                                                                            </td>
                                                                        </tr>
                                                            ...
                                                            <tr>
                                                                <td align="center"
                                                                    ...
                                                                    <p
                                                                        ...
                                                                        Tu crecimiento es nuestra razón de ser...
                                                                    </p>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                        ...
                                                                        <tr class="links">
                                                                            <td align="center" valign="top"
                                                                                ...
                                                                                <div
                                                                                    ...
                                                                                    <a target="_blank"
                                                                                        href="https://zephyrea.com.mx/"
                                                                                        style="mso-line-height-rule:exactly;text-decoration:none;font-family:arial, 'helvetica neue', helvetica, sans-serif;display:block;color:#999999;font-size:12px">Visitanos
                                                                                    </a>
                                                                                </div>
                                                                            </td>
                                                                            <td align="center" valign="top"
                                                                                ...
                                                                                <div
                                                                                    style="vertical-align:middle;display:block">
                                                                                    <a target="_blank"
                                                                                        href="https://zephyrea.com.mx/contact"
                                                                                        style="mso-line-height-rule:exactly;text-decoration:none;font-family:arial, 'helvetica neue', helvetica, sans-serif;display:block;color:#999999;font-size:12px">Contactanos</a>
                                                                                </div>
                                                                            </td>
                                                                            <td valign="top" width="33.33%"
                                                                                ...
                                                                                <div
                                                                                    style="vertical-align:middle;display:block">
                                                                                    <a target="_blank"
                                                                                        href="https://zephyrea.com.mx/about"
                                                                                        style="mso-line-height-rule:exactly;text-decoration:none;font-family:arial, 'helvetica neue', helvetica, sans-serif;display:block;color:#999999;font-size:12px">Nosotros</a>
                                                                                </div>
                                                                            </td>
                                                                        </tr>
                                                                    </table>
