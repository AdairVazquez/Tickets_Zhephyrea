                ...
                <div wire:ignore id="carouselPersonalizado" class="inicio-carousel" data-interval="5000">
                    <div class="inicio-carousel__track" data-carousel-track>
                        @forelse($imagenes as $imagen)
                            <div class="inicio-carousel__slide {{ $loop->first ? 'is-active' : '' }}"
                                data-carousel-slide>
                    ...
                    @if ($imagenes->count() > 1)
                        <button class="inicio-carousel__control prev" type="button" data-carousel-prev
                            aria-label="Anterior">
                            &#10094;
                        </button>
                        <button class="inicio-carousel__control next" type="button" data-carousel-next
                        ...
                        <div class="inicio-carousel__indicators" data-carousel-indicators>
                            @foreach ($imagenes as $index => $imagen)
                                <button type="button"
                                    class="inicio-carousel__dot {{ $loop->first ? 'is-active' : '' }}" data-carousel-dot
